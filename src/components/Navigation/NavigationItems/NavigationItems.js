    ...
    render () {
        return (
            <NavigationList display={this.props.display}>
                ...
                <ListItem onClick={this.props.clicked} textSize={this.props.textSize}>{this.props.token ? <NavLink activeStyle={{color: 'red'}} onClick={this.logOutHandler} to="/logged-out">Log Out</NavLink> : <NavLink activeStyle={{color: 'red'}} to="/sign-in">Sign In</NavLink>}</ListItem>
            </NavigationList>
        )
    }
}
